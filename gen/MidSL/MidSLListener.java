...
public interface MidSLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MidSLParser#opaque_type}.
	 * @param ctx the parse tree
	 */
	void enterOpaque_type(MidSLParser.Opaque_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MidSLParser#opaque_type}.
	 * @param ctx the parse tree
	 */
	void exitOpaque_type(MidSLParser.Opaque_typeContext ctx);
	/**
	 * Enter a parse tree produced by {@link MidSLParser#float_opaque_type}.
	 * @param ctx the parse tree
	 */
	void enterFloat_opaque_type(MidSLParser.Float_opaque_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MidSLParser#float_opaque_type}.
	 * @param ctx the parse tree
	 */
	void exitFloat_opaque_type(MidSLParser.Float_opaque_typeContext ctx);
	/**
	 * Enter a parse tree produced by {@link MidSLParser#int_opaque_type}.
	 * @param ctx the parse tree
	 */
	void enterInt_opaque_type(MidSLParser.Int_opaque_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MidSLParser#int_opaque_type}.
	 * @param ctx the parse tree
	 */
	void exitInt_opaque_type(MidSLParser.Int_opaque_typeContext ctx);
	/**
	 * Enter a parse tree produced by {@link MidSLParser#u_int_opaque_type}.
	 * @param ctx the parse tree
	 */
	void enterU_int_opaque_type(MidSLParser.U_int_opaque_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MidSLParser#u_int_opaque_type}.
	 * @param ctx the parse tree
	 */
	void exitU_int_opaque_type(MidSLParser.U_int_opaque_typeContext ctx);
	/**
