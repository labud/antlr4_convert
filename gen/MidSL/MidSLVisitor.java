...
public interface MidSLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MidSLParser#opaque_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOpaque_type(MidSLParser.Opaque_typeContext ctx);
	/**
	 * Visit a parse tree produced by {@link MidSLParser#float_opaque_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFloat_opaque_type(MidSLParser.Float_opaque_typeContext ctx);
	/**
	 * Visit a parse tree produced by {@link MidSLParser#int_opaque_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInt_opaque_type(MidSLParser.Int_opaque_typeContext ctx);
	/**
	 * Visit a parse tree produced by {@link MidSLParser#u_int_opaque_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitU_int_opaque_type(MidSLParser.U_int_opaque_typeContext ctx);
	/**
